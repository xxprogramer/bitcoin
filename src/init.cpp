...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-pools_conf=<file>", strprintf("Specify pools file. Relative paths will be prefixed by datadir location. (default: %s)", BITCOIN_CONF_FILENAME), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
#if HAVE_DECL_DAEMON
